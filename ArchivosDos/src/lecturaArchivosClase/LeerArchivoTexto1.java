      ...
      try // lee registros del archivo, usando el objeto Scanner
      {
         ...
         while ( entrada.hasNext() )
         {
            String linea = entrada.nextLine();
             ...
             ArrayList<String> linea_partes = new ArrayList<String>(Arrays.asList(linea.split(";"))); // crea una lista utilizando arrays de la linea y hazle un split con ;. split es que lo separe
             System.out.println(linea_partes);
            /*for (int i=0; i<linea_partes.size(); i++){ //se usa el size para arraylist
